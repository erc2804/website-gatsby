var jumpLocked = false,
    ...
    collIntval = null,
    collidedArr = [
      { id: 1, name: "portfolio", cloudBtm: 80 + "%", url: encodeURI("https://www.ercancicek.com/portfolio") },
      { id: 2, name: "socialmedia", cloudBtm: 60 + "%", url: "https://www.linkedin.com/in/ercancicek" },
      { id: 3, name: "aboutme", cloudBtm: 75 + "%", url: "https://www.ercancicek.com/about-me" }
    ],
    tutorialSeen = true,
    inTutorial = false;
